...
impl Shop {
    ...
    fn most_expensive(&self) -> u32 {
        let mut expensive_card: u32 = 0;
        for card in self.cards.iter() {
            if card.price > expensive_card {
                expensive_card = card.price;
            }
        }
        expensive_card
    }
    ...
    fn total_damage(&self) -> u32 {
        let mut all_damage: u32 = 0;
        for card in self.cards.iter() {
            all_damage += card.damage;
        }
        all_damage
    }
    ...
    fn total_health(&self) -> u32 {
        let mut all_health: u32 = 0;
        for card in self.cards.iter() {
            all_health += card.health;
        }
        all_health
    }
}
